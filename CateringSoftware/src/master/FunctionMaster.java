 ...
 * @author @JD@
 */
public class FunctionMaster extends javax.swing.JInternalFrame {
    ...
    public FunctionMaster() {
        ...
        tableForView();
        addValidation();
        setTitle(Constants.FUNCTION_MASTER_FORM_NAME);
    }
    ...
    private void onViewVoucher() {
        ...
        String sql = "SELECT name_en FROM function_master";
        viewTable.setColumnValue(new int[]{1});
        String view_title = Constants.FUNCTION_MASTER_FORM_NAME +" VIEW";

        HeaderIntFrame1 rptDetail = new HeaderIntFrame1(dataConnection, lb.getFunctionData(id, "N"), view_title, viewTable, sql, Constants.FUNCTION_MASTER_FORM_ID, 1, this,this.getTitle());
        rptDetail.makeView();
    ...
    public void dispose() {
        try {
            ...
            lb.printToLogFile("Exception at dispose In Function Master", ex);
        }
    }
        ...
        if (!navLoad.getMode().equalsIgnoreCase("")) {
            if (comp == jtxtEngName) {
                ...
                if (navLoad.getMode().equalsIgnoreCase("N")) {
                    if (lb.isExist("function_master", "name_en", jtxtEngName.getText(), dataConnection)) {
                        navLoad.setMessage("Name is already exist!");
                        comp.requestFocusInWindow();
                        return false;
                    }
                } else if (navLoad.getMode().equalsIgnoreCase("E")) {
                    if (lb.isExistForEdit("function_master", "name_en", jtxtEngName.getText(), "id", String.valueOf(id), dataConnection)) {
                        navLoad.setMessage("Name is already exist!");
                        comp.requestFocusInWindow();
                        return false;
                    }
    ...
    private void setVoucher(String tag) {
        try {
            navLoad.setComponentEnabledDisabled(false);
            String sql = "SELECT * FROM function_master";
            ...
            lb.setPermission(navLoad, Constants.FUNCTION_MASTER_FORM_ID);
        } catch (Exception ex) {
            lb.printToLogFile("Exception at setVoucher In Function Master", ex);
        }
    }

    private void onPrintVoucher() {
        try {
            VoucherDisplay vd = new VoucherDisplay(id, Constants.FUNCTION_MASTER_INITIAL);
            DeskFrame.addOnScreen(vd, Constants.FUNCTION_MASTER_FORM_NAME +" PRINT");
        } catch(Exception ex) {
            lb.printToLogFile("Exception at onPrintVoucher In Function Master", ex);
        }
    }
    ...
    private int saveVoucher() {
        ...
        try {
            ...
            if (navLoad.getMode().equalsIgnoreCase("N")) {
                id = lb.generateKey("function_master", "id", Constants.FUNCTION_MASTER_INITIAL, 7);
                sql = "INSERT INTO function_master(name_en, name_gu, name_hi, user_cd, fk_status_id, id) " +
                    "VALUES (?, ?, ?, ?, ?, ?)";
            } else if (navLoad.getMode().equalsIgnoreCase("E")) {
                sql = "UPDATE function_master SET name_en = ?, name_gu=?, name_hi=?, user_cd = ?, fk_status_id = ?, edit_no = edit_no + 1,"
            ...
            try {
                ...
                dataConnection.setAutoCommit(true);
                lb.printToLogFile("Error at save In Function Master", ex);
            } catch (SQLException ex1) {
                lb.printToLogFile("Error at rollback save In Function Master", ex1);
            }
        }
        return data;
    }
        ...
        class smallNavigation extends SmallNavigation {
            ...
            public void callDelete() {
                ...
                if (lb.type) {
                    try {
                        dataConnection.setAutoCommit(false);
                        String sql = "DELETE FROM function_master WHERE id = ?";
                        ...
                        lb.printToLogFile("Exception at callDelete In Function Master", ex);
                        try {
                            dataConnection.rollback();
                            dataConnection.setAutoCommit(true);
                        } catch (Exception ex1) {
                            lb.printToLogFile("Exception at rollback callDelete In Function Master", ex1);
                        }
                    }
                } else {
            ...
            public void setComponentTextFromResultSet() {
                try {
                    ...
                    lb.printToLogFile("Exception at setComponentTextFromResultSet In Function Master", ex);
                }
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 3, 3, new java.awt.Color(235, 35, 35)), "Function Master", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 2, 16), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jtxtHinName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtxtHinNameActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtxtHinName, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jcmbStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jtxtGujName, javax.swing.GroupLayout.PREFERRED_SIZE, 270, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel4, jLabel5, jLabel9});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jcmbStatus, jtxtEngName, jtxtGujName, jtxtHinName});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel2, jtxtEngName});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel3, jtxtGujName});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel9, jtxtHinName});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel5, jcmbStatus});
    ...
    private void jtxtIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtIDKeyPressed
        if(navLoad.getMode().equalsIgnoreCase("")) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                if(lb.isExist("function_master", "id", jtxtID.getText(), dataConnection)) {
                    id = jtxtID.getText();
                    navLoad.setMessage("");
                    setVoucher("edit");
                } else {
                    navLoad.setMessage("Function Master ID is invalid");
                }
            }
    ...
    private void jtxtHinNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtxtHinNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtxtHinNameActionPerformed
